  ...
  return (
    <div className="mainUserDiv">
      ...
      <div className="userContent">
        <div className="p-2 m-0 h-100 container-fluid row text-center text-center text-capitalize">
          <div className="row py-4 m-0 w-100 justify-content-center d-flex align-items-center">
            <div className="userAvatar bg-light ">
              <div
                className="initialsText m-0 h-100 d-flex align-items-center justify-content-center text-dark font-weight-bold">SJ
              </div>
            </div>
          </div>
          <div className=" col userFields m-0 w-100 mx-2 d-flex flex-column align-items-center">
            <Slide>
              <div className="row ">
                ...
                <div className="col m-0 py-3 w-100"><h3>First Name</h3></div>
              </div>
              <div className="row">
                <div className="col-3">
                  <FontAwesomeIcon icon={faUser} className="text-white-50"
                ...
                <div className="col m-0 py-3 w-100"><h3>Last Name</h3></div>
              </div>
            </Slide>
          </div>
          <div className="col userFields m-0 w-100 mx-2 d-flex flex-column align-items-center">
            <Slide>
              <div className="row ">
                ...
                <div className="col m-0 py-3 w-100"><h3>Email</h3></div>
              </div>
              <div className="row">
                <div className="col-3">
                ...
                <div className="col m-0 py-3 w-100"><h3>Password</h3></div>
              </div>
            </Slide>
          </div>
        </div>
